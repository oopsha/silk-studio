...
export const enMessages = {
  ...
  settings: {
    ...
    database: {
      ...
      showObjectDescriptions: "Explorer: Show Object Descriptions",
      showObjectDescriptionsDescription:
        "Show each database object's comment or description beside its name in the Explorer tree.",
      showObjectDescriptionsHint: "Show object descriptions",
  ...
  workbench: {
    ...
    sidebar: {
      ...
      openEditorsFilterPlaceholder: "Search tabs by name",
      openEditorsShowCommands: "Show and Run Commands",
      openEditorsOpenQuickChat: "Open Quick Chat",
    ...
    commands: {
      ...
      exportAiCallLog: "Export AI Call Log...",
      clearAiCallLog: "Clear AI Call Log",
      ...
      refreshActiveSchema: "Refresh Schema/Catalog",
    ...
    keybindings: {
      hint: "Click a keybinding to change it. Search by command or key.",
      ...
      change: "Change Keybinding",
      reset: "Reset Keybinding",
      confirm: "Accept",
      capturePrompt: "Press desired key combination. Escape to cancel.",
      conflictWarning: "Already used by “{label}”",
  ...
  app: {
    ...
    connectionTarget: {
      ...
      pickerEmpty: "No saved connections. Add one in the Connections explorer.",
      pickerNoMatch: "No matching connections.",
      selectTargetTitle: "Select Query Target…",
      databasesEmpty: "No databases to show.",
      noDatabase: "No database",
      databasePickerTitle: "Select database for this connection",
      databasePickerPlaceholder: "Filter databases…",
      databaseAriaLabel: "Database target: {label}",
      connectFailed: "Failed to connect.",
      noSchema: "No schema",
      schemasEmpty: "No schemas to show.",
      schemaPickerTitle: "Select schema for this connection",
      schemaPickerPlaceholder: "Filter schemas…",
      schemaAriaLabel: "Schema target: {label}",
    },
    transaction: {
    ...
    explorer: {
      ...
      newQueryWithConnection: "New Query with this Connection",
      ...
      useSchema: "Use This Schema",
      usingSchema: "Using schema {name}",
      setDefaultSchema: "Set as Default Schema",
      defaultSchemaSet: "Set {name} as the default schema",
      setDefaultSchemaFailed: "Failed to set default schema",
      useSchemaFailed: "Could not switch schema",
      useSchemaUnsupported: "This driver does not support schema switching",
      ...
      duplicateProcedure: "Duplicate Procedure…",
    ...
    ddl: {
      ...
      savePackageTitle: "Save changed Spec/Body and recompile the package",
    },
    packageMembers: {
      loading: "Loading members...",
      loadFailed: "Failed to load package members.",
      empty: "No members.",
      name: "Name",
      openHint: "Double-click to jump to the implementation in Body",
    },
    general: {
      name: "Name",
      type: "Type",
    ...
    arguments: {
      ...
      loadFailed: "Failed to load arguments.",
    ...
    tableStructure: {
      ...
      save: "Save",
      saving: "Saving…",
      saveFailed: "Failed to save table structure.",
      savePendingCommit:
      ...
      saveDialogTitle: "Save Table Structure",
      saveDialogSummary: "Apply these changes to {label}?",
      changesTab: "Changes",
      sqlTab: "SQL",
      confirmButton: "Apply Changes",
      noChanges: "No changes to apply.",
      tableSection: "Table",
      addedSection: "Added Columns",
      droppedSection: "Dropped Columns",
    ...
    query: {
      ...
      setEmptyValue: "Set Empty Value",
      setNullValue: "Set NULL",
      setCurrentTime: "Set Current Time",
      currentTimeValue: "Now",
      loadingFullValue: "Loading full text...",
      loadFullValueFailed: "Failed to load full text: {message}",
      fullValueUnavailable: "The full value is unavailable, so the shortened preview cannot be saved.",
      copySelection: "Copy Selected Cells",
      ...
      clearColumnFilter: "Clear This Filter",
      ...
      copySelectionTitle: "Copy selected cells",
      ...
      filterPlaceholder: "Filter history and favorites",
      filterAria: "Filter history and favorites",
      clearFilter: "Clear filter",
