...
export const koMessages = {
  ...
  settings: {
    ...
    database: {
      ...
      showObjectDescriptions: "탐색기 > 객체 설명 표시",
      showObjectDescriptionsDescription:
        "탐색기 트리에서 데이터베이스 객체 이름 옆에 코멘트/설명을 표시합니다.",
      showObjectDescriptionsHint: "객체 설명 표시",
  ...
  workbench: {
    ...
    sidebar: {
      ...
      openEditorsFilterPlaceholder: "탭 이름으로 검색",
      openEditorsShowCommands: "명령 표시 및 실행",
      openEditorsOpenQuickChat: "빠른 채팅 열기",
    ...
    commands: {
      ...
      shrinkSelection: "선택 축소",
      copyLineUp: "줄 복사(위)",
      copyLineDown: "줄 복사(아래)",
      moveLineUp: "줄 이동(위)",
      moveLineDown: "줄 이동(아래)",
      duplicateSelection: "선택 영역 복제",
      addCursorAbove: "위에 커서 추가",
      addCursorBelow: "아래에 커서 추가",
      addCursorsToLineEnds: "줄 끝마다 커서 추가",
      addNextOccurrence: "다음 항목 선택 추가",
      addPreviousOccurrence: "이전 항목 선택 추가",
      ...
      newAiChat: "새 AI 채팅",
      exportAiCallLog: "AI 호출 로그 내보내기...",
      clearAiCallLog: "AI 호출 로그 지우기",
      ...
      toggleStickyScroll: "스티키 스크롤 토글",
      toggleWordWrap: "자동 줄바꿈 토글",
      editConnection: "연결 편집...",
      duplicateConnection: "연결 복제",
      refreshActiveSchema: "스키마/카탈로그 새로 고침",
      deleteConnection: "연결 삭제...",
      exportConnections: "연결 내보내기...",
      importConnections: "연결 가져오기...",
      signIn: "로그인...",
      editProfile: "프로필 편집...",
      signOut: "로그아웃",
      executeAll: "모두 실행",
    ...
    keybindings: {
      hint: "단축키를 클릭해서 변경할 수 있습니다. 명령 또는 키로 검색하세요.",
      ...
      reset: "기본값으로 초기화",
      confirm: "적용",
      capturePrompt: "원하는 키 조합을 누르세요. 취소하려면 Escape.",
      conflictWarning: "이미 “{label}”에서 사용 중입니다",
      changedBadge: "변경됨",
    },
    about: {
      title: "{name} 정보",
  ...
  app: {
    ...
    connectionTarget: {
      ...
      pickerEmpty: "저장된 연결이 없습니다. Connections 탐색기에서 추가하세요.",
      pickerNoMatch: "일치하는 연결이 없습니다.",
      selectTargetTitle: "쿼리 대상 선택…",
      databasesEmpty: "표시할 데이터베이스가 없습니다.",
      noDatabase: "데이터베이스 없음",
      databasePickerTitle: "이 연결의 데이터베이스 선택",
      databasePickerPlaceholder: "데이터베이스 필터…",
      databaseAriaLabel: "데이터베이스 대상: {label}",
      connectFailed: "연결에 실패했습니다.",
      noSchema: "스키마 없음",
      schemasEmpty: "표시할 스키마가 없습니다.",
      schemaPickerTitle: "이 연결의 스키마 선택",
      schemaPickerPlaceholder: "스키마 필터…",
      schemaAriaLabel: "스키마 대상: {label}",
    },
    transaction: {
    ...
    explorer: {
      ...
      reconnect: "재연결",
      reconnected: "{name}: 재연결했습니다",
      newQueryWithConnection: "이 연결로 새 쿼리",
      ...
      useSchema: "이 스키마 사용",
      usingSchema: "{name} 스키마를 사용합니다",
      setDefaultSchema: "기본 스키마로 설정",
      defaultSchemaSet: "{name}을(를) 기본 스키마로 설정했습니다",
      setDefaultSchemaFailed: "기본 스키마를 설정하지 못했습니다",
      useSchemaFailed: "스키마를 전환하지 못했습니다",
      useSchemaUnsupported: "이 드라이버는 스키마 전환을 지원하지 않습니다",
      ...
      duplicateObject: "객체 복제…",
      duplicateView: "뷰 복제…",
      duplicateProcedure: "프로시저 복제…",
      duplicateFunction: "함수 복제…",
      duplicatePackage: "패키지 복제…",
      newIndex: "새 인덱스…",
      newTrigger: "새 트리거…",
      newProcedure: "새 프로시저…",
      newFunction: "새 함수…",
    ...
    query: {
      ...
      editValue: "값 편집...",
      setEmptyValue: "빈값 설정",
      setNullValue: "NULL 설정",
      setCurrentTime: "현재 시각 설정",
      currentTimeValue: "Now",
      loadingFullValue: "전체 텍스트를 불러오는 중...",
      loadFullValueFailed: "전체 텍스트를 불러오지 못했습니다: {message}",
      fullValueUnavailable: "전체 값을 불러올 수 없어 잘린 미리보기는 저장할 수 없습니다.",
      copySelection: "선택한 셀 복사",
      copySelectedRows: "선택한 행 복사",
      copyAllFiltered: "필터된 모든 행 복사",
      exportCsv: "CSV 내보내기(필터)",
      clearFilters: "결과 필터 지우기",
      clearColumnFilter: "이 필터 지우기",
      pasteFailed: "붙여넣기에 실패했습니다",
      sortAscending: "오름차순 정렬",
      sortDescending: "내림차순 정렬",
      clearSort: "정렬 지우기",
      autoSizeColumn: "열 너비 자동 맞춤",
      autoSizeAllColumns: "열 전체 너비 자동 맞춤",
      hideColumn: "열 숨기기",
      pinColumnLeft: "열 왼쪽 고정",
      unpinColumn: "열 고정 해제",
    ...
    plsql: {
      ...
      saveTitle: "변경사항 비교 후 저장 및 컴파일",
      compileTitleNoDiagnostics: "확인 없이 즉시 저장 (Ctrl+Shift+F9)",
      saveTitleNoDiagnostics: "변경사항 비교 후 저장",
